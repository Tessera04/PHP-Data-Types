...
setlocale( LC_TIME, 'es', 'spa', 'es_ES' ); //Establece el idioma de php
date_default_timezone_set( 'Australia/Sydney' ); //Zona Horaria. lo sacamos del manual de php
			...
			<article class="post">
				...
				<footer>
					<span class="post-date">
						Publicada en:
						<?php /*Metodo deprecado*/	echo strftime( '%d %b %Y', strtotime( $post['published_on'] ) );	?>
